...
class CustomLogger:
    """
    Кастомный логгер для модуля разметки англицизмов.
    ...
    Attributes:
        ...
        logger_name (str): Имя логгера, по умолчанию "AngliсismLabeler"
        logger (logging.Logger): Основной объект логгера
    """

    def __init__(self, config, logger_name: str = "AngliсismLabeler") -> None:
        """
    ...
    def get_log_filename(self, logs_dir: str) -> str:
        ...
        return os.path.join(logs_dir, f'anglicism_labeler_{timestamp}.log')
