...
- Магистерская диссертация по применению методов машинного обучения для автоматического выявления и замены англицизмов в русскоязычных новостных статьях

## Описание проекта

Данный проект представляет собой комплексную систему для:
1. **Парсинга и сбора** новостных текстов
2. **Автоматического выявления** англицизмов в русскоязычных текстах
3. **Генерации замен** англицизмов на подходящие русские синонимы
4. **Обучения моделей** машинного обучения для классификации англицизмов
5. **Создания эталонных датасетов** с размеченными заменами
...
### 🏷️ Модули разметки данных
- **`label_data/`** - Автоматическая разметка англицизмов в текстах
- **`label_ML_data/`** - Применение ML-моделей для выявления англицизмов

### 🤖 Модули машинного обучения
- **`classic_ML_models/`** - Классические алгоритмы (Random Forest, XGBoost, Logistic Regression)
- **`base_model/`** - Дообучение языковых моделей (LLM) для замены англицизмов
- **`train/`** - Обучение моделей Qwen для генерации замен

### 📊 Модули создания датасетов
...
- **Гордеева Наталия Георгиевна**
- Магистерская программа по машинному обучению
