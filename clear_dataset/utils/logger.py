...
class CustomLogger:
    """
    Кастомный логгер для модуля предобработки текстов.
    ...
    Attributes:
        ...
        logger_name (str): Имя логгера, по умолчанию "TextPreprocessor"
        logger (logging.Logger): Основной объект логгера
    """

    def __init__(self, config, logger_name: str = "TextPreprocessor") -> None:
        """
    ...
    def get_log_filename(self, logs_dir: str) -> str:
        ...
        return os.path.join(logs_dir, f'text_preprocessor_{timestamp}.log')
